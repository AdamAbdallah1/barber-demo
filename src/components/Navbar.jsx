  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 ${
        scrolled
          ? "backdrop-blur-xl border-b border-white/[0.02] py-4"
          : "bg-transparent py-6"
      }`}
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-12 flex items-center justify-between">
        ...
        <a href="#" className="flex flex-col z-50 relative">
          <span className="text-white text-xl font-bold tracking-[0.2em] uppercase leading-none">
            {barberData.shortName}
          </span>

          <span className="text-[#C5A059] text-[10px] tracking-[0.4em] uppercase mt-1">
            {barberData.name.replace(barberData.shortName, "").trim() || "Barber Club"}
          </span>
        </a>
